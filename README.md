...
Files:
- Motown_Era_MJ_token_hidden.ipynb is the main analysis notebook. Motown_Era.csv contains the raw Spotify playlist data exported via Exportify.
- Motown_Era_with_lyrics.csv is the dataset with lyrics added.
